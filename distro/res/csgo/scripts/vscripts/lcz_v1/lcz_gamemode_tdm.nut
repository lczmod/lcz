/**
 * TDM base game settings, applied automatically at the game start after core settings.
 *
 * Changelog:
 * - Version 1.0
 *   Initial release
 ...
 *
 * @param	scriptScope	scope of this loaded script.
 */
function lczOnGamemodeLoad()
{
	lcz.announcements.push("[LCZ] Gamemode: Team deathmatch. 2 teams.");
}